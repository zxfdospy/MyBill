...
public class ChartUtil {
    private static String[] sampleLabels(LinkedList<Record> rs) {
    ...
    public static double[] sampleValues(LinkedList<Record> rs) {
    ...
    public static Image getImage(LinkedList<Record> rs, int width, int height) {
        // 根据消费记录得到的样本数据
        ...
        // 样本值的字体
        chart.setFont("rangeLabelFont", new Font("微软雅黑",0, 12));
        // 显示图例说明
        ...
        // 图例说明的字体
        chart.setFont("legendFont", new Font("微软雅黑", 0, 13));
        // 下方文字的字体
        chart.setFont("sampleLabelFont", new Font("微软雅黑", 0, 13));
        // 图表中间背景颜色
